...
Smtp_Receiver_test = ['yanglei@tenez.cn','yangyaojun@tenez.cn']
...
#测试用例及报告路径配置参数
test_dir = r'D:\WorkSpace\Python\Wm_UI\test_case'
test_report = 'D:\\WorkSpace\\Python\\Wm_UI_TEST\\test_report\\'
