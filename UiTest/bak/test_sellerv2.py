...
class Seller(unittest.TestCase):
    ...
    def test_aOrderDetail(self):
        ...
        try :
            ...
            time.sleep(1)
            get_orderInfo = driver.find_element_by_xpath(".//*[@id='cly_order_list']/li[1]/form/table/thead/tr/th[1]/span[2]/span").text
            # 获取订单单号  通过正则提取
            print get_orderInfo
            ...
            # 查看订单详情
            time.sleep(1)
            detail_tag = driver.find_element_by_xpath(".//*[@id='cly_order_list']/li[1]/form/table/thead/tr/th[1]/span[3]/span/a").text
            time.sleep(1)
            ...
            time.sleep(2)
            # detail_tag = u"订单信息"
            get_orderDetail = driver.find_element_by_xpath(".//*[@id='order_status']/div[1]/a").text
    ...
    def test_cReleases(self):
        ...
        try:
            ...
            releaseFile = r'D:\Automationtest\caseData' + '\itemRelease.xlsx'
	    print releaseFile
            #print releaseFile_Path
            time.sleep(2)
            driver.find_element_by_css_selector(".webuploader-pick").click()
    ...
    def test_eItemsUpdate(self):
        ...
        if releasesStatus == 1:
            try:
                ...
                updataFile = r'D:\Automationtest\caseData' + '\itemUpdate.xlsx'
                time.sleep(2)
                driver.find_element_by_css_selector(".webuploader-pick").click()
                time.sleep(2)
                # 将路径输入
                ...
                '''
                #方法二 使用工具
                updataFile = r"D:\Automationtest\caseData\itemUpdate.exe"
                os.system(updataFile)
                time.sleep(1)
                driver.find_element_by_xpath(".//*[@id='file_upload_btn']").click()
                time.sleep(6)
